    ...
    if request.method == 'GET':
        ...
        if request.POST['password1'] == request.POST['password2']:
            try:
                ...
                return render(request, 'signupuser.html', {'form' : UserCreationForm(), 'error' : 'The username has already been taken, try another one'})
        else:
...
def createtodo(request):
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'createtodo.html', {'form' : TodoForm(), 'error' : "Bad data pass in. Try again"})
...
def viewtodo(request, todo_pk):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'viewtodo.html', {'todo' : todo, 'form' : form, 'error' : "Bad data pass in. Try again"})
